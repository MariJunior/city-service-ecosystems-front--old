    ...
    slides: [
      {
        ...
        subtitle:
          'Краткое описание Поддержка и развитие регионов  и развитие регионов',
...
const ApplicationsSliderStory: Story<ApplicationSliderProps> = (props) => (
  <ApplicationsSlider {...props}  />
);
