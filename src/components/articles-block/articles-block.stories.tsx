...
export default {
  ...
  args: {
    cards: [
      {
        title:
          'Что изменилось в начислении пособий для безработных в 2020 году',
...
const ArticlesBlockStory: Story<ArticlesBlockPropsInterface> = (
  args: ArticlesBlockPropsInterface
) => <ArticlesBlock {...args} />;
