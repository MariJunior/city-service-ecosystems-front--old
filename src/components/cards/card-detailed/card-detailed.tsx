...
export interface CardDetailedProps extends AppCardBasicProps, React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement> {
  appSummary: React.ReactNode,
