...
import {
  CatalogEditorsChoice,
  CatalogEditorsChoiceProps,
} from './catalog-editors-choice';
...
const CatalogEditorsChoiceStory: Story<CatalogEditorsChoiceProps> = (
  args: CatalogEditorsChoiceProps
