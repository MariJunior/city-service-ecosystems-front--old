...
export interface LinkButtonRoundedProps extends React.DetailedHTMLProps<React.HTMLAttributes<HTMLAnchorElement>, HTMLAnchorElement> {
  link?: string,
...
export function LinkButtonRounded({
  link,
  platform,
  length,
  icon,
