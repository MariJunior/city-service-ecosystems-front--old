...
const ReviewCardStory: Story<ReviewCardProps> = (props: ReviewCardProps) => (
  <ReviewCard
    ...
    review={text('review', 'Наряду с этим, изменение глобальной стратегии развивает культурный имидж. До недавнего времени считалось, что реклама вырождена. Рекламное сообщество определяет пресс-клиппинг.')}
