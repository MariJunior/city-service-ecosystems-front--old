...
import { ReactComponent as ArrowSubmit } from '../../icons/arrow-submit.svg';

export interface SubscribeFormProps extends React.DetailedHTMLProps<React.HTMLAttributes<HTMLFormElement>, HTMLFormElement> {}
    ...
    <form {...props} >
      ...
      <PrivacyWrapper>
        <PrivacyCheckbox
          ...
          required
          inputProps={{ 'aria-label': 'Согласие с политикой конфиденциальности' }}
        />
        <PrivacyLabel>
