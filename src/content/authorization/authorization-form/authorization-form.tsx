...
export interface AuthorizationFormProps extends AuthFormBaseProps, React.DetailedHTMLProps<React.HTMLAttributes<HTMLFormElement>, HTMLFormElement> {
    ...
    <Form id={formId} {...props}>
      <If condition={userChoice === 'entry'}>
        ...
        <FormWrap>
          ...
          <FormRecoveryLink href={recoveryLink}>
            Забыли пароль?
          </FormRecoveryLink>
        </FormWrap>
        ...
        <FormGosuslugi href={gosuslugiAuth}>
...
const FormField = styled.input<FormFieldProps>`
  ...
  border: none;
  border-radius: 10px;
  background-image: radial-gradient(35.57% 337.4% at 35.22% 263%, #F7D6F2 0%, rgba(247, 214, 243, 0) 100%), linear-gradient(90deg, #E1D7F9 0%, #DED8FB 100%);
...
const FormGosuslugi = styled.a<FormGosuslugiProps>`
  ...
  text-decoration: none;
  border-radius: 10px;
  background-image: radial-gradient(43.72% 311.11% at 39.95% -89.81%, #F7D6F2 0%, rgba(247, 214, 243, 0) 100%), linear-gradient(90deg, #CAE6FB 0%, #DED8FB 100%);
  transition: all 0.3s;
