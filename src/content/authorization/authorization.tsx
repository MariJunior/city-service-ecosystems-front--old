...
import { ReactComponent as AuthIcon } from '../../icons/auth-icon-btn.svg';
import { ReactComponent as AuthIconClose } from '../../icons/auth-icon-close.svg';
...
export interface AuthorizationProps extends AuthFormBaseProps, React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement> {}
  ...
  return (
    <>
      ...
      <AuthorizationOverlay
        ...
        {...props}
      >
        <BlurIcon userStatus={userChoice}>
        </BlurIcon>
        <ContentWrapper>
          <FormTitle>
